...
$routes->delete('sessions/bookings/(:num)', 'SessionBookingController::delete/$1'/*, ['filter' => 'auth']*/);
$routes->post('sessions/bookings', 'SessionBookingController::create'/*, ['filter' => 'auth']*/);
